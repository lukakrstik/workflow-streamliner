...
public class WIWS {
    public static void main(String[] args) throws IOException {
        ...
        for (int counter3 = 0; arrayComp[counter3] != null && arrayThumb[counter3] != null; counter3++) {
            arrayComp[counter3] = "https://github.com/lukakrstik/website-photo-pool/blob/master/images/" + arrayComp[counter3];
            arrayThumb[counter3] = "https://github.com/lukakrstik/website-photo-pool/blob/master/images/" + arrayThumb[counter3];
        }
        System.out.println("All URLs Generated B)");
        System.out.println("================================================================");

        for (int counter4 = 0; arrayComp[counter4] != null && arrayThumb[counter4] != null; counter4++) {
            System.out.println("<div class=\"card m-2\" style=\"border: none;\">\n"+
            "\t<a href=\"" + arrayComp[counter4] + "\" data-fancybox=\"gallery\">\n"+
            "\t\t<img class=\"card-img\" src= \"" + arrayThumb[counter4] + "\">\n"+
            "\t</a>\n"+
            "</div>\n\n");
        }
    }
